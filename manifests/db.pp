...
#
# [*db_host*]
#   The hostname/IP if the database is network-hosted. See trac main options.
#
# [*db_schema*]
#   The schema name for the (postgresql) database. Undefined for default schema.
#
# [*db_user*]
